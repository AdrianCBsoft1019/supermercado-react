...
export default function Carrousel() {
  ...
  const slides = [
    {
      id: 1,
      image: 'https://www.imbanaco.com/idcsalud-client/cm/images?locale=es_CO&idMmedia=2493074',
    ...
    {
      id: 3,
      image: 'https://www.revistamoi.com/wp-content/uploads/2019/06/guia-de-carnes.jpg',
      title: 'Carnes finas',
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="font-bold text-lg mb-2">Envíos Gratis</h3>
              <p className="text-gray-600">En pedidos mayores a $100.000</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="font-bold text-lg mb-2">Garantía Fresco</h3>
              <p className="text-gray-600">Si tus productos estan frescos y en buen estado, si no, te devolvemos tu dinero</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <h3 className="font-bold text-lg mb-2">Entrega Rápida</h3>
              <p className="text-gray-600">Entrega de 24 H</p>
            </div>
          </div>
        </div>
      </div>
